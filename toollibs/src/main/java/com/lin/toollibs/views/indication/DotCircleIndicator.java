 ...
 * 圆点指示器（带比较顺畅的滑动处理）
 */
public class DotCircleIndicator extends View implements ViewPager.OnPageChangeListener {
    //选中画笔
    ...
    public DotCircleIndicator(Context context) {
        this(context, null);
    }

    public DotCircleIndicator(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DotCircleIndicator(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
